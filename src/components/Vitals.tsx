  ...
  return (
    <div className="vitals">
      <div className="focus-card">
        ...
        <div className="sub">{fmtHM(s.build_ms)} build ÷ {fmtHM(s.active_ms)} active</div>
      </div>

      <div className="vital-grid">
        <div className="vital"><div className="k">active</div><div className="v">{fmtHM(s.active_ms)}</div></div>
        <div className="vital"><div className="k">idle</div><div className="v">{fmtHM(s.idle_ms)}</div></div>
        <div className="vital"><div className="k">switches</div><div className="v">{s.context_switches}</div></div>
        <div className="vital"><div className="k">longest focus</div><div className="v">{fmtHM(s.longest_focus_ms)}</div></div>
